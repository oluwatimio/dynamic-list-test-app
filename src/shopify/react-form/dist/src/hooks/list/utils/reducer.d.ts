...
export declare function addFieldsAction<Item>(list: Item[]): AddFieldAction<Item>;
export declare function removeFieldsAction(indexToRemove: number): RemoveFieldAction;
