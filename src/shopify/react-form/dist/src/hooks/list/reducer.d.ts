...
export declare type ListAction<Item> = ReinitializeAction<Item> | AddFieldsAction<Item> | RemoveFieldsAction | UpdateErrorAction<Item> | UpdateAction<Item, keyof Item> | ResetAction<Item, keyof Item> | NewDefaultAction<Item, keyof Item>;
...
export declare function addFieldsAction<Item>(list: Item[]): AddFieldsAction<Item>;
export declare function removeFieldsAction(indexToRemove: number): RemoveFieldsAction;
