 ...
 * @param lists - Pass in list objects
...
export function useForm<T extends FieldBag>({
  ...
  const formLists = lists?.dynamicList
  const fieldWithList = {...fields, dynamicListFields: formLists?.fields}
  ...
  return {
    fields,
    dirty: !formLists ? dirty  : dirty || formLists.dirty,
    submitting,
    submit,
    reset,
    validate,
