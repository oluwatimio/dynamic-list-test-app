...
import { defaultDirtyComparator, shallowArrayComparison } from "../../utilities.mjs";
...
export function makeFieldReducer(_ref) {
  var _ref$dirtyStateCompar = _ref.dirtyStateComparator,
      dirtyStateComparator = _ref$dirtyStateCompar === void 0 ? defaultDirtyComparator : _ref$dirtyStateCompar;
