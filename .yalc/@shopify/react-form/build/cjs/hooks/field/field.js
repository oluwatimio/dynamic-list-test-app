...
function useField(input) {
  ...
  var validators = (0, _utilities.normalizeValidation)(validates);

  var _useFieldReducer = (0, _reducer.useFieldReducer)(value, dirtyStateComparator),
      _useFieldReducer2 = _slicedToArray(_useFieldReducer, 2),
      state = _useFieldReducer2[0],
      dispatch = _useFieldReducer2[1];

  var resetActionObject = (0, _react.useMemo)(function () {
    return (0, _reducer.resetAction)();
  }, []);
  var reset = (0, _react.useCallback)(function () {
    return dispatch(resetActionObject);
  }, [dispatch, resetActionObject]);
  var newDefaultValue = (0, _react.useCallback)(function (value) {
    return dispatch((0, _reducer.newDefaultAction)(value));
  }, [dispatch]);
  var runValidation = (0, _react.useCallback)(function () {
  ...
  var setError = (0, _react.useCallback)(function (value) {
    return dispatch((0, _reducer.updateErrorAction)(value));
  }, [dispatch]);
