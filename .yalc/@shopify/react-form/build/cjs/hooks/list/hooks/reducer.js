...
var _index3 = require("../../field/index.js");
    ...
    case 'updateError':
      {
        ...
        currentItem[key] = (0, _index3.reduceField)(currentItem[key], (0, _index3.updateErrorAction)(error));
        return _objectSpread(_objectSpread({}, state), {}, {
    ...
    case 'reset':
      {
        ...
        _currentItem[_key] = (0, _index3.reduceField)(_currentItem[_key], {
          type: 'reset'
        });
        return _objectSpread(_objectSpread({}, state), {}, {
          list: _toConsumableArray(state.list)
    ...
    case 'newDefaultValue':
      {
        ...
        _currentItem2[_key2] = (0, _index3.reduceField)(_currentItem2[_key2], {
          type: action.type,
          payload: value
        });
        return _objectSpread(_objectSpread({}, state), {}, {
...
function initialListItemState(item) {
  return (0, _utilities.mapObject)(item, _index3.initialFieldState);
}